...
<?php
    if (isset($_POST['delete'])) {
        ...
        $sql = "delete from blockreserve  WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($id));
...
<head>
    ...
    <body>
        ...
        <section class="main-content">
			...
			<br><br><br>
               <div class="container"  style="width:50%;margin:auto;background-color:white"><br>
					<div class="span10 offset1">
							...
							<h1 style="text-align:center">Supprimer réservation:</h1>
						<br>

						<form class="form-horizontal"  method="post">
							
							<p style="font-size:20pt;text-align:center">Vous êtes sur de supprimer cette réservation ?</p>
							<input type="hidden" name="id" value="<?php echo $id;?>"/><br>
							<div class="form-actions" style="width:25%;margin:auto">
								<button type="submit" name="delete" class="btn btn-danger">Oui</button>
								<a class="btn" href="../accueil.php">Non</a>
							</div>
							<br>
						</form>
					</div>
            ...
            <footer class="footer">
                <span>Copyright &copy; 2019 kourmou.omar@gmail.com</span>
            </footer>
